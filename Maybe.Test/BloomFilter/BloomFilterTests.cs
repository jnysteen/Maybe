...
namespace Maybe.Test.BloomFilter
{
    public class BloomFilterTests
    {
        ...
        public Property Contains_With5PercentFalsePositives_ShouldHaveLessThan5PercentErrors()
        {
            ...
            {
                var filter = new BloomFilter<int>(stepRange, errorRate/100d, ByteConverter);
        ...
        {
            var filter = new BloomFilter<int>(1000, 0.05, ByteConverter);
        ...
        public void Contains_WhenItemHasBeenAdded_AndFilterHasBeenSerializedAndUnserialized_ShouldReturnTrue()
        {
            ...
            {
                var filterOld = new BloomFilter<int>(50, 0.02, ByteConverter);
                filterOld.Add(42);
        ...
        {
            Assert.Throws<ArgumentException>(() => BloomFilter<int>.Create(0, 0.5, ByteConverter));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new BloomFilter<int>(0, 0.5d, ByteConverter));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new BloomFilter<int>(-100, 0.5d, ByteConverter));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new BloomFilter<int>(100, -5d, ByteConverter));
        }
